...
const inputSchema = {
    clientId: z.string().describe('ID of the client this invoice is for'),
...
export const createInvoiceTool: ToolDescriptor<typeof inputSchema> = {
    name: 'create_invoice',
    description: 'Create a new invoice for a client in the active company. Use create_invoice_from_quote instead when the invoice should come from an existing quote.',
